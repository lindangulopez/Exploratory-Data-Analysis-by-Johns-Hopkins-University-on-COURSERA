...
## ----,echo=FALSE,fig.cap="Initialize centroids"--------------------------
plot(x,y,col="blue",pch=19,cex=2)
text(x+0.05,y+0.05,labels=as.character(1:12))
cx <- c(1,1.8,2.5)
cy <- c(2,1,1.5)
...
## ----,echo=FALSE,fig.cap="Assign points to nearest centroid"-------------
plot(x,y,col="blue",pch=19,cex=2)
...
## ----,fig.cap="Re-calculate cluster centroids",echo=FALSE----------------
plot(x,y,col="blue",pch=19,cex=2)
cols1 <- c("red","orange","purple")
text(x+0.05,y+0.05,labels=as.character(1:12))
...
## ----,echo=FALSE,fig.cap="Re-assign points to new cluster centroids"-----
plot(x,y,col="blue",pch=19,cex=2)
cols1 <- c("red","orange","purple")
text(x+0.05,y+0.05,labels=as.character(1:12))
...
## ----,echo=FALSE,fig.cap="Updated centroid configuration"----------------
plot(x,y,col="blue",pch=19,cex=2)
cols1 <- c("red","orange","purple")
text(x+0.05,y+0.05,labels=as.character(1:12))
...
## ----,fig.cap="K-means clustering solution",echo=FALSE-------------------
...
## ----,tidy=TRUE,fig.cap="Heatmap of K-means solution"--------------------
par(mfrow=c(1,2))
